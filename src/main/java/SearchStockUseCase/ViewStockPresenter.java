...
//    private final ViewStockController controller;
    public ViewStockPresenter(iViewStockGUI view, Portfolio portfolio){
        this.view = view;
...
//    private void onBack() {
//        String compPortfolioName = this.user.getCompPortfolio().getName();
...
//    }
    ...
    private void onSellStock() {
        //call Sell Presenter
        view.close();
        new SellStockPresenter(OuterLayerFactory.instance.getSellGUI(view.getStockSymbol()), this.portfolio);
    }

    public void onBuyStock(){
        //Call Buy Presenter
        view.close();
        new BuyStockPresenter(OuterLayerFactory.instance.getBuyGUI(view.getStockSymbol()), this.portfolio);
    }
}
