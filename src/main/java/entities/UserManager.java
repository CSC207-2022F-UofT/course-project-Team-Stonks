...
public class UserManager {
    ...
    public User convertUserDSResponse(UserDSResponse userDSResponse) throws ParseException {
        return userFactory.createUser(userDSResponse.username(), userDSResponse.password(), dateFormat.parse(userDSResponse.lastLogin()), userDSResponse.portfolios(), dbGateway);
    }
}