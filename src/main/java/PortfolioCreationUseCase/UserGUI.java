...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        userPanel.setPreferredSize(new Dimension(474, 369));
        ...
        Font portfoliosFont = this.$$$getFont$$$(null, -1, 18, portfolios.getFont());
        if (portfoliosFont != null) portfolios.setFont(portfoliosFont);
        portfolios.setForeground(new Color(-16752965));
        ...
        userPanel.add(portfolios, new GridConstraints(1, 3, 3, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_WANT_GROW, new Dimension(250, 250), new Dimension(250, 250), null, 0, false));
        logOut = new JButton();
